...
"")
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(688, 10, 726, 701))
...
"")
        ...
        self.lb_cameraTime = QtWidgets.QLabel(self.tab_mainScreen)
        self.lb_cameraTime.setGeometry(QtCore.QRect(355, 18, 101, 20))
        font = QtGui.QFont()
        ...
        font.setWeight(50)
        self.lb_cameraTime.setFont(font)
        self.lb_cameraTime.setStyleSheet("")
        self.lb_cameraTime.setAlignment(QtCore.Qt.AlignCenter)
        self.lb_cameraTime.setObjectName("lb_cameraTime")
        self.lb_record = QtWidgets.QLabel(self.tab_mainScreen)
        self.lb_record.setGeometry(QtCore.QRect(335, 20, 20, 20))
        self.lb_record.setStyleSheet("QLabel {\n"
"    border-radius: 10px;\n"
"    background-color: red;\n"
"}")
        self.lb_record.setText("")
        self.lb_record.setObjectName("lb_record")
        self.lb_airSpeed_2 = QtWidgets.QLabel(self.tab_mainScreen)
        self.lb_airSpeed_2.setGeometry(QtCore.QRect(566, 650, 51, 31))
        ...
        self.lb_groundSpeed_2.setGeometry(QtCore.QRect(385, 650, 51, 31))
        self.lb_groundSpeed_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lb_groundSpeed_2.setObjectName("lb_groundSpeed_2")
        self.lb_airSpeedIndicatorTick_2 = QtWidgets.QLabel(self.tab_mainScreen)
        self.lb_airSpeedIndicatorTick_2.setGeometry(QtCore.QRect(506, 540, 170, 170))
        self.lb_airSpeedIndicatorTick_2.setStyleSheet("background-color: rgb(255, 255, 255, 0);")
        self.lb_airSpeedIndicatorTick_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.lb_airSpeedIndicatorTick_2.setText("")
        self.lb_airSpeedIndicatorTick_2.setPixmap(QtGui.QPixmap(":/hud/icons/speed-indicator-tick.png"))
        self.lb_airSpeedIndicatorTick_2.setScaledContents(True)
        self.lb_airSpeedIndicatorTick_2.setObjectName("lb_airSpeedIndicatorTick_2")
        self.cb_followUav = QtWidgets.QCheckBox(self.tab_mainScreen)
        self.cb_followUav.setGeometry(QtCore.QRect(1279, 30, 121, 23))
        self.cb_followUav.setStyleSheet("color: white;")
        self.cb_followUav.setObjectName("cb_followUav")
        self.lb_airSpeedIndicatorTick_3 = QtWidgets.QLabel(self.tab_mainScreen)
        self.lb_airSpeedIndicatorTick_3.setGeometry(QtCore.QRect(325, 540, 170, 170))
        self.lb_airSpeedIndicatorTick_3.setStyleSheet("background-color: rgb(255, 255, 255, 0);")
        self.lb_airSpeedIndicatorTick_3.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.lb_airSpeedIndicatorTick_3.setText("")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_flightTime.setText(_translate("MainWindow", "Uçuş Süresi (dk): "))
        ...
        self.lb_cameraTime.setText(_translate("MainWindow", "00:03:20"))
